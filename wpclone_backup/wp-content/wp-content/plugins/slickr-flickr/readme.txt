...
= 2.8.1 = Mandatory:  Add missing script
= 2.8 = Optional:  Internationalisation and WordPress 5.6
= 2.7.2 = Optional: Updates for SimplePie 1.5.4, PHP 7.4 WordPress 5.4 and Galleria 1.6.1
= 2.7.1 =  Fix vimeo reference to use https
