...
Rstudio- 
The data wrangling process has been implemented using rstudio which involves the following steps
...
Tableau -
We used tableau to visualise the data from the final cleaned dataset which we got after the data wrangling process in r studio. We had created two visualisations in tableau which are as follow –
...
RShiny dashboard - 
Shiny dashboard has been used to create the plastic footprint calculator which is present in the calculator tab of the webpage.
Steps followed –
